...
package com.wab.lernapp.wizard.ui;
...
import com.wab.lernapp.R;
import com.wab.lernapp.ThemeUtils;
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch(ThemeUtils.getCurrentTheme())
        {
            case ThemeUtils.GREEN:
                mSelectedTabPaint.setColor(res.getColor(R.color.greenPrimary));
                mSelectedLastTabPaint.setColor(res.getColor(R.color.greenAccent));
                break;
            case ThemeUtils.ORANGE:
                mSelectedTabPaint.setColor(res.getColor(R.color.orangePrimary));
                mSelectedLastTabPaint.setColor(res.getColor(R.color.orangeAccent));
                break;
            case ThemeUtils.YELLOW:
                mSelectedTabPaint.setColor(res.getColor(R.color.yellowPrimary));
                mSelectedLastTabPaint.setColor(res.getColor(R.color.yellowAccent));
                break;
            default:
                mSelectedTabPaint.setColor(res.getColor(R.color.greenPrimary));
                mSelectedLastTabPaint.setColor(res.getColor(R.color.greenAccent));
